...
namespace English.help
{
    public class DBHelper
    {
        ...
        public static MySqlConnection Connection
        {
            get
            {
                string sql = System.Configuration.ConfigurationManager.ConnectionStrings["English"].ToString();
                MySqlConnection myConn = new MySqlConnection(sql);
