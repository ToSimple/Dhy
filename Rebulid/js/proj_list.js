	...
	RENDER = [
		function(proj_list) {
		    ...
		    $.each(proj_list, function (idx) {
				...
				back += '			</p>';
				back += '		</div>';
				back += '		<div class="bottom">';
				back += '			<span><i class="fa fa-heart"></i>' + this.likes_count + '</span>';
				back += '			<span><i class="fa fa-comments"></i>' + this.comments_count + '</span>';
				back += '			<span><i class="fa fa-code-fork"></i>' + this.forks_count + '</span>';
				back += '		</div>';
				back += '	</div>';
				back += '</div>';
			})
